...
require_once dirname(__FILE__) . "/Message/Mime.php";
require_once dirname(__FILE__) . "/Message/Part.php";
require_once dirname(__FILE__) . "/Message/Attachment.php";
require_once dirname(__FILE__) . "/Message/EmbeddedFile.php";
require_once dirname(__FILE__) . "/Message/Image.php";

if (!defined("SWIFT_VERSION")) define("SWIFT_VERSION", "3.0.0_4");
