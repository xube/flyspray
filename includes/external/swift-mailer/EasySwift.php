...
require_once dirname(__FILE__) . "/Swift/Message/Encoder.php";
require_once dirname(__FILE__) . "/Swift/Connection/Sendmail.php";
require_once dirname(__FILE__) . "/Swift/Plugin/EasySwiftResponseTracker.php";
