...
if (!$page) {
  ...
  if ($upgraded != 'yes' && $prev_ver == 'yes') {
    ...
    echo '<table class="admin"><tr><td class="admintext">This script will upgrade your Flyspray database structure for use with Flyspray 0.9.7.';
    echo '<br><br><a href="' . $_SERVER['PHP_SELF'] . '?page=2">Perform upgrade now!</a></td></tr></table>';
    
  } else {
  
    echo '<table class="admin"><tr><td class="admintext">Your Flyspray database has already been upgraded for use with version 0.9.7.  You can delete this script.<br><br>';
  ...
  if ($upgraded != 'yes' && $prev_ver == 'yes') {
   ...
   echo '<table class="admin"><tr><td class="admintext">Your Flyspray database is now upgraded for use with version 0.9.7.  You should delete the entire <i>sql/</i> directory.<br><br>';
   echo '<br /><br />';
   ...
   echo '<a href="../">Take me to Flyspray 0.9.7 now!</a></td></tr><table>';
    ...
    echo '<table class="admin"><tr><td class="admintext">Your MYSQL Flyspray database has already been upgraded for use with version 0.9.7.  You should delete the entire <i>sql/</i> directory.<br><br>';
    echo '<a href="../">Take me to Flyspray 0.9.7 now!</a></td></tr><table>';
