...
'vote'                    => 'Гласуване',
'groupopen'               => 'Членовете могат да влизат',
...
'addvotes'                => 'Може да гласува за задачи',
...
'depremoved'              => 'Зависимостта е премахната:',
...
'taskwatching'            => 'Задача, която наблюдавате',
...
'assignmentchanged'       => 'Променено назначение',
...
'any'                     => 'Без значение',
'useradded'               => 'Потребителят е добавен към групата',
'addormoveusers'          => 'Добавяне (или ако е необходимо преместване) на един или повече потребители',
'currentglobalgroups'     => 'Текущи глобални групи',
'dependencygraphfor'      => 'Графика на зависимостите за',
'defaultsortcolumn'       => 'Колона за сортиране по подразбиране',
'asc'                     => 'Нарастващ',
'desc'                    => 'Намаляващ',
'sendbackground'          => 'Фоново изпращане на известията',
'reopenedby'              => 'Повторно отворена от',
'openedtasks'             => 'Отворени задачи',
'closedtasks'             => 'Затворени задачи',
'reopenedtasks'           => 'Повторно отворени задачи',
'assignedtasks'           => 'Собственост на новите задачи',
'digestfor'               => 'Вашият седмичен дайджест за',
'senddigest'              => 'Изпращане на дайджест на проект менажерите',
'notifyblacklist'         => 'Забрана на известията',
'currentgroups'           => 'Текущи групи',
'userremovedproject'      => 'Потребителят е премахнат от проекта',
'projectmanagers'         => 'Проект менажер(и)',
'addmoretasks'            => 'Добавяне на нови задачи от този тип',
'showeventssince'         => 'Показване на събитията след',
'notes'                   => 'Бележки',
'mynotifications'         => 'Моите известия',
'addnote'                 => 'Добавяне на бележка',
'notesubject'             => 'Тема',
'savednotes'              => 'Записани бележки',
'enternotesubject'        => 'Въведете поне тема за вашата бележка',
'noteadded'               => 'Бележката е добавена',
'confirmdeletenote'       => 'Действително ли желаете бележка да бъде премахната?',
'notedeleted'             => 'Бележката е премахната',
'updatenote'              => 'Промяна на бележката',
'nosubject'               => '(няма тема)',
'noteupdated'             => 'Бележката е променена',
'allowanonuserlist'       => 'Анонимните потребители да виждат списъка с потребителите',
'viewuserlist'            => 'Списък с потребители',
'anonviewtasks'           => 'Анонимните потребители да виждат задачите',
'lists'                   => 'Списъци',
'listtype'                => 'Тип на списъка',
'basic'                   => 'Основен',
'list'                    => 'Списък',
'ldapnotsupported'        => 'LDAP разширениеto на PHP не е инсталирано. Следователно LDAP не се поддържа и няма нищо за конфигуриране.',
'ldapenabled'             => 'LDAP разрешен',
'ldapserver'              => 'LDAP сървър',
'ldapbasedn'              => 'Базов DN',
'ldapuserkey'             => 'Потребителски ключ',
'ldapuser'                => 'Потребитеско име за връзката',
'ldappassword'            => 'Парола за връзката',
'ldap'                    => 'LDAP конфигурация',
'jabbernotsupported'      => 'XML разширението на PHP не е инсталирано; по тази причина поддръжката за Jabber не е достъпна.',
'tls'                     => 'TLS',
'phpversion'              => 'Версия на PHP',
'writable'                => 'възможен запис',
'available'               => 'достъпен',
'notavailable'            => 'недостъпен',
'notwritable'             => 'невъзможност за запис',
'fileaccess'              => 'Файлов достъп',
'fsversion'               => 'Версия на Flyspray',
'database'                => 'база данни',
'files'                   => 'файлове',
'extensions'              => 'Разширения',
'functions'               => 'Функции',
'affects:/flyspray.conf.php'=> 'Трябва да бъде записваем само когато е актвно обновяването.',
'affects:/cache'          => 'възможността за запис е необходима за Dokuwiki (ако е позволено) и за кеширане на RSS емисиите.',
'affects:/attachemts'     => 'възможността за запис е необходима за прикачените файлове',
'affects:openssl'         => 'липсва SSL/TLS поддръжка за Jabber и електронна поща',
'affects:xml'             => 'няма поддръжка за Jabber',
'affects:shell_exec'      => 'генериране на локални графики на зависимост не е възможно, ако DOT е активно/налично',
'affects:ldap'            => 'няма поддръжка за LDAP',
'affects:stream_socket_enable_crypto'=> 'няма поддръжка на TLS в Jabber',
'affects:dns_get_record'  => 'невъзможност за използване на GTalk за известяване чрез Jabber',
'allitems'                => 'Всички',
'fields'                  => 'Полета',
'type'                    => 'Тип',
'notspecified'            => 'Не е указано',
'state'                   => 'Състояние',
'roadmapfield'            => 'Пътната карта е на основание на',
'versiontense'            => 'Време на версията',
'defaultvalue'            => 'Стойност по подразбиране',
'forcedefaulttip'         => 'Стойност по подразбиране за нови задачи',
'forcedefault'            => 'Стойност по подразбиране',
'required'                => 'Задължително',
'duplicateres'            => 'Резолюция за дублирани задачи',
'unlimited'               => 'Неограничен',
'fieldadded'              => 'Полето е добавено.',
'fieldsupdated'           => 'Полетата са обновени.',
'listadded'               => 'Списъкът е добавен.',
'listsupdated'            => 'Списъкът е обновен.',
'taskalreadyclosed'       => 'Задачата вече е затворена.',
'notedoesnotexist'        => 'Избраната бележка не съществува.',
'errorocurred'            => 'Грешка',
'inputerror'              => 'Грешка във входните данни. Подадени са невалидни данни на Flyspray, така че заявката не може да бъде изпълнена. Ако сте сигурен/на, че сте подал/а валидни данни, разглеждайте това като грешка във Flyspray. Бихме се радвали да ни изпратите съобщение, за да можем да я премахнем.',
'permserror'              => 'Нямате достатъчно права да видите тази страница или да изпълните това действие.',
'dberror'                 => 'Грешка, свързана с базата данни. За подробности вижте информацията по-долу.',
'internalerror'           => 'Вътрешна грешка. Допълнителни данни за нея са дадени по-долу. Причината е или грешка във Flyspray, или неправилна конфигурация.',
'location'                => 'Място',
'overrideuserlang'        => 'Да не се ползва избраният от потребителя език',
'preferredlanguage'       => 'Предпочитан език',
'flysprayresponse'        => 'Отговор на Flyspray',
'syntax'                  => 'Синтаксис',
'viewprivate'             => 'Разглеждане на частни задачи',
'showcontact'             => 'Показване на информация за контакт',
'isadmin'                 => 'Администратор',
'massedit'                => 'Групово редактиране',
'editnote'                => 'Забележка: Възможно е да нямате достатъчно права да промените всички свойства на всичките задачи, които сте избрали. В такъв случай някои от задачите могат да останат непроменени.',
'selectedtasks'           => 'Избрани задачи',
'applychanges'            => 'Прилагане на промените',
'masseditsuccessful'      => 'Груповото редактиране е успешно',
'notasksselected'         => 'Не е избрана нито една задача',
'usernameoremail'         => 'Потребителско име или е-мейл адрес',
'editprivate'             => 'Промяна частна <-> публична задача',
'confidential'            => 'Частна',
'projectprefix'           => 'Префикс на проекта',
'projectlevelid'          => 'Проект ID',
'badprefix'               => 'Невалиден префикс. Префиксът или вече се използва от друг проект или в него има невалидни символи.',
'searchindetails'         => 'Търсене в описанието на задачата',
'activateuser'            => 'Ръчно активиране на нерегистриран потребител (по потребителско име) ',
'useractivated'           => 'Потребителят е активиран успешно.',
'nounregistereduser'      => 'Не е намерен нерегистриран потребител с това име.',
...
'changelogreso'           => 'Резолюции за дневника',
'changelogfor'            => 'Дневник за _',
'nochangelog'             => 'В дневника няма данни. Проверете дали сте избрали някакави резолюции в конфигурацията на проекта.',
'groupnotexist'           => 'Избраната група не съществува в този проект.',
'inactivityclose'         => 'Затваряне поради неактивност след',
'stopautoclose'           => 'Прекратяване на автоматичното затваряне',
'autoclosingstopped'      => 'Автоматичното затваряне е прекратено',
'taskautoclosedmsg'       => 'Задачата е конфигурирана за автоматично затваряне поради неактивност',
'tasknotautoclosing'      => 'Задачата не е конфигурирана за автоматично затваряне поради неактивност',
'pastpresent'             => 'Минало + Сегашно',
'futurepast'              => 'Бъдеще + Минало',
'presentfuture'           => 'Сегашно + Бъдеще',
'bounceaddress'           => 'Адрес за съобщаване за неизпратени съобщения',
'select'                  => 'Избор',
'userselect'              => 'Избор на потребител',
'defaultusers'            => 'Потребители по подразбиране',
'userecaptcha'            => 'Използване на reCAPTCHA',
'recaptchapublickey'      => 'reCAPTCHA - публичен ключ',
'recaptchaprivatekey'     => 'reCAPTCHA - частен ключ',
'disabled'                => 'Забранено',
'author'                  => 'Автор',
'commitmessage'           => 'Съобщение',
'revision'                => 'Ревизия',
'feedsandsvn'             => 'Емисии и SVN',
'svnurl'                  => 'Адрес на хранилището',
'svnuser'                 => 'SVN потребителско име',
'svnpassword'             => 'SVN парола',
'svnlog'                  => 'SVN съобщение при поверяване',
'svnnoconnection'         => 'FLyspray не можа да се свърже със SVN сървъра',
'searchforbugs'           => 'Търсене на задачи',
'relatedcommits'          => 'Транзакции за поверяване',
'relateditems'            => 'Свързани обекти',
'viewsvn'                 => 'Разглеждане на съобщенията при SVN поверяване',
'variousperms'            => 'Разнообразни',
'specialperms'            => 'Специални разрешения',
'taskperms'               => 'Задачи',
'assignmentperms'         => 'Назначения',
'commentperms'            => 'Коментари',
'attachmentperms'         => 'Прикачени файлове',
'ldapbindmethod'          => 'Метод на LDAP свързване',
'ldapbinddn'              => 'Свързване на DN + повторно свързване',
'ldapbindpw'              => 'Парола за свързване',
'ldapanonymous'           => 'Анонимно',
'ldapdirect'              => 'Директно свързване',
'mailheaders'             => 'Mail headers',
'createnewfromthis'       => 'Създаване на нова група от тази',
'quicklinks'              => 'Бързи връзки',
'globalemail'             => 'Е-мейл за всички известия',
'globaljabber'            => 'Jabber ID за всички известия',
'colorfield'              => 'Оцветяване на база на',
'toggleexpansion'         => 'Отваряне/затваряне на подробности на задачите',
'noresultsshort'          => 'Няма резултати',
'export'                  => 'Експортиране',
'iCal'                    => 'iCal',
'calendarexport'          => 'Експортиране за календари като iCal',
'csv'                     => 'CSV',
'mailtask'                => 'На кой емайл адрес желаете да изпратите тази задача?',
'moveup'                  => 'Нагоре',
'movedown'                => 'Надолу',
'moveleft'                => 'Наляво',
'moveright'               => 'Надясно',
'linktotask'              => 'Връзка към задачата',
'emailtask'               => 'Изпращане на задачата по емейл',
'syntaxplugins'           => 'Синтактични приставки',
'cannotedittaskglobally'  => 'Задача не може да бъде преместена в глобалния проект. Не е трябвало да имате такава възможност.',
'options'                 => 'Опции',
'selectuser'              => 'Избор на потребител',
'usernotinglobalgroup'    => 'Този потребител не е член на нито една глобална група, въпреки че това е необходимо. Моля редактирайте записите си за него.',
'ldapconerror'            => 'Невъзможност за свързване с LDAP сървър',
'ldaperror'               => 'LDAP грешка',
'recentlyclosed'          => 'Последно затворени задачи',
'showasassignees'         => 'Показване като изпълнители',
'changedby'               => 'Последна промяна от',
'moveallof'               => 'Преместване на вслички елементи от',
'movelistto'              => 'в',
'merge'                   => 'Обединяване',
'listsarethesame'         => 'Двата списъка са еднакви и не могат да се обединят',
'listtypesnotequal'       => 'Избраните списъци не са от един и същи тип',
'listsmerged'             => 'Списъците са обединени успешно.',
'UTC'                     => 'UTC',
'ldaprealnamekey'         => 'Ключ на LDAP реално име',
'ldapemailkey'            => 'Ключ на LDAP е-мейл',
);
