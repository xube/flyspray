...
<form name="form1" action="<?php echo $baseurl;?>index.php" method="post" id="registernewuser">

<h1><?php echo $newuser_text['registernewuser'];?></h1>

<p><em><?php echo $newuser_text['requiredfields'];?></em> <strong>*</strong></p>
...
<table class="admin">
  <tr>
    <td>
      ...
      <label for="username"><?php echo $newuser_text['username'];?></label>
    </td>
