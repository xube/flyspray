<div id="toolbox">
  ...
  <form action="{$this->url(array('admin', 'prefs'))}" method="post">
  <ul id="submenu">
    ...
    <div id="userregistration" class="tab">
      <table class="box">
        ...
        <tr>
          ...
          <td><input id="recaptcha_priv_key" name="recaptcha_priv_key" class="text" type="text" size="40" value="{$fs->prefs['recaptcha_priv_key']}" /></td>
		</tr>
