...
<div>
  ...
  <span id="links">
    ...
    <a id="forgotlink" href="mailto:{implode(',', $admin_emails)}?subject={rawurlencode(L('lostpwforfs'))}&amp;body={rawurlencode(L('lostpwmsg1'))}{$this->relativeUrl($baseurl)}{rawurlencode(L('lostpwmsg2'))}<?php
