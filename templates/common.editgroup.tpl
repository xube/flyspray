<fieldset class="admin"> <legend>{$language['editgroup']}</legend>
  ...
  <form action="{$baseurl}?project={$group_details['belongs_to_project']}" method="post">
    <table class="admin">
      ...
      <tr>
        <td colspan="2">{$language['notshownforadmin']}</td>
      </tr>
      <?php else: ?>
      <tr>
        <td><label for="projectmanager">{$language['projectmanager']}</label></td>
        <td>{!tpl_checkbox('manage_project', $group_details['manage_project'], 'projectmanager')}</td>
      </tr>
      <tr>
        <td><label for="viewtasks">{$language['viewtasks']}</label></td>
        <td>{!tpl_checkbox('view_tasks', $group_details['view_tasks'], 'viewtasks')}</td>
      </tr>
      <tr>
        <td><label for="canopenjobs">{$language['opennewtasks']}</label></td>
      ...
      <tr>
        <td><label for="canaddcomments">{$language['addcomments']}</label></td>
      ...
      <tr>
        <td><label for="addtoassignees">{$language['addtoassignees']}</label></td>
      ...
      <tr>
        <td><label for="canvote">{$language['canvote']}</label></td>
