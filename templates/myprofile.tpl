      ...
      <tr>
        ...
        <td>
          ...
          <select id="notifytype" name="notify_type">
            {!tpl_options(array('None', 'Email', 'Jabber'), $current_user['notify_type'])}
          </select>
          <?php else: ?>
      ...
      <tr>
        ...
        <td>
          <input id="dateformat_extended" name="dateformat_extended" type="text"
            size="40" maxlength="30" value="{$current_user['dateformat_extended']}" />
        </td>
      </tr>
      <tr>
        ...
        <td>
          <select name="tasks_perpage" id="tasks_perpage">
            {!tpl_options(array(10, 25, 50, 100, 250), $current_user['tasks_perpage'], true)}
          </select>
        </td>
      </tr>
      <tr>
