...
{
    $db->x->execParam('DELETE FROM {history} WHERE history_id = ?', array($row['history_id']));
    ...
    $db->x->execParam("INSERT INTO {history} (task_id, user_id, event_date, event_type, field_changed, old_value, new_value)
