...
?>
		<div id="right">
			...
			<div class="installBlock">
				...
				<p>Setting up <?php echo $product_name; ?> to run on your server involves 3 simple steps...</p>
				<p>
				Please enter the hostname of the server <?php echo $product_name; ?> is to be installed on,
				this is usually 'localhost'.
				</p>
				<p>
				Enter the Database username and password for the database you are using for setting up
				<?php echo $product_name; ?>.
				</p>
				<p style="font-weight:bold;">
				It is strongly advised to make a backup of the databases/tables which may be affected with
				the username password you provide for this setup. <?php echo $product_name; ?> authors will
				not be held responsibile for any loss of data you experience if things go wrong. However we
				try to do our best to avoid such circumstances.
				</p>
