...
?>
		<div id="right">
			...
			<div class="formBlock" style="width:100%;left: -6px; position:relative;">
				<iframe src="../docs/licences/Flyspray.licence.txt" class="license" frameborder="0" scrolling="auto"></iframe>
			</div>
			</div>
			<div class="clr"></div>
